...
// export const GA_TRACKING_ID = 'G-4LDK1CPP7W'
...
// export const event = ({ action, value ,category}) => {
//   window.gtag('event', action, value,category)
// }
...
export async function init(G='G-4LDK1CPP7W') {
